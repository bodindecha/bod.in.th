...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<style type="text/css">
			...
			html body main div.container > h1 { font-weight: 500; }
		...
		<script type="text/javascript">
			$(document).ready(function() {
				<?php if(isset($_GET['return_url']))echo"app.sys.auth.orize('".urldecode($_GET['return_url'])."')"; ?>
			});
		</script>
	</head>
	<body>
		...
		<main shrink="<?php echo($_COOKIE['sui_open-nt'])??"false"; ?>">
			<div class="container">
				<center><button onClick="app.sys.auth.orize()" class="green">เข้าสู่ระบบ</button></center>
			</div>
		</main>
