		<?php
			$heading_name = "Bodin URL shortener"; $heading_domain = "inf.bodin.ac.th";
			$heading_title = ((isset($header_title))?$header_title." | ":"").$heading_name;
			$heading_desc = (isset($header_desc))?str_replace("\"","'",$header_desc):"ระบบย่อลิ้งก์โรงเรียนบดินทรเดชา (สิงห์ สิงหเสนี)";
			$heading_cover = ((isset($header_cover))?$header_cover:"images/logo.png");
		?>
		<!-- Settings -->
		<meta charset="UTF-8" />
